...
export const jurisdictionConfig: Record<JurisdictionCode, JurisdictionConfig> = {
  mt: {
    ...
    location: {
      name: "Pietà",
      eyebrow: "Pietà registered office · Malta-wide service",
      headline: "Our registered office is in Pietà.",
      streetAddress: "144/9 Palazzo Marina, Marina Street",
      addressLocality: "Pietà",
      addressRegion: "Eastern Region",
      addressCountry: "MT",
      postalLabel: "144/9 Palazzo Marina, Marina Street, Pietà PTA 9043, Malta",
      mapUrl: "https://www.google.com/maps/search/?api=1&query=144%2F9+Palazzo+Marina%2C+Marina+Street%2C+Pieta+PTA+9043%2C+Malta",
      latitude: 35.894976,
      longitude: 14.491316,
      geoRegion: "MT-41",
      coverage:
        "Serving businesses, organisations and finance teams across Malta and Gozo through online and appointment-led engagements.",
    },
    operationalNotice:
